...
export type EmbeddedAppConfigBase<TState extends object = DefaultState, TMessage = unknown> = {
...
export type EmbeddedAppConfigWithState<TState extends object = DefaultState, TMessage = unknown> = {
  ensureState: TState;
} & EmbeddedAppConfigBase<TState, TMessage>;

export type EmbeddedAppConfig<TState extends object = DefaultState, TMessage = unknown> = {
  ensureState?: TState;
} & EmbeddedAppConfigBase<TState, TMessage>;
